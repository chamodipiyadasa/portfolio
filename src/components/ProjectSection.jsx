...
<div className="container mx-auto max-w-5xl">
  ...
  <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
    Here are some of my recent projects that showcase my skills and expertise in web development. Each project is a testament to my commitment to quality and innovation.
  </p>
...
className="text-foreground/80 hover:text-primary transition-colors duration-300">
  ...
  <div className="text-center mt-12">
    ...
    target="_blank"
    href="https://github.com/chamodipiyadasa"> 
